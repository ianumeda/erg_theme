<div id="header">
  ...
  <nav class="container-fluid navbar navbar-default navbar-fixed-top" role="navigation">
    ...
    <div id="topnav" class="row collapse navbar-collapse navbar-ex1-collapse">
    	...
    	<div class="col-md-3 col-sm-12">
			  ...
			  <div id="sb-search-top" class="sb-search hidden-xs">
  				<form action="<?php echo home_url('/erg-search'); ?>" method="get">
  					<input class="sb-search-input" placeholder="Search the ERG website..." type="field" value="" name="search_for" id="s">
...
<div class="" id="page_head" style="background-image:url(<?php header_image(); ?>);">
  <div class="" id="branding"> </div>
</div>
<?php } ?>
