...
?>
<div class="person_<?php echo str_replace(' ','_',strtolower($person_type)); ?> person_item " data-last-initial="<?php echo substr(get_the_title($post->ID),0,1); ?>">
  <div>
...
<?php 
    if(has_post_thumbnail( $post->ID ) ){
      ...
      $imgurl=$image[0];
?>
      <div class="image headshot square" style="background-image: url('<?php echo $imgurl; ?>')"></div>
<?php 
  }
?>
