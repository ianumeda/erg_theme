...
<div class="container">
    ...
    <div class="row person_page <?php foreach($positions as $position) { echo "position_".$position->slug." "; }?>">
      <?php $menu='People'; ?>
        ...
        <div class="row">
          <div id="person_title" class="col-xs-12">
            <h2 class="section_heading">
              <?php 
                echo '<span class="preheading">';
                $i=0;
                foreach($positions as $position) { 
                  echo $position->slug; 
                  if($i<count($positions)-1) echo " / ";
                  $i++;
                }
                echo " : </span>"; ?>
              <?php
...
<div class="row">
  ...
  elseif ($positions[0]->slug=='researcher') echo 'Researchers'; 
