  ...
  <div class="col-lg-12">
    <?php Starkers_Utilities::get_template_parts( array( 'parts/shared/page-menu' ) ); ?>
      <div class="col-md-10">
        ...
        <div class="row">
          <div id="news_feed" class="col-sm-7 ">
            ...
            <?php
              ...
              if ( $query->have_posts() ) {
              	while ( $query->have_posts() ) {
              		$query->the_post(); ?>
                  <div class="news_item post_preview">
            ...
            <div class="news_item">
              ...
              ?>
              <button class="btn btn-block btn-sm"><a href="<?php echo $category_link; ?>" alt="Go to the News Archive">Go to the News Archive <span class="glyphicon glyphicon-chevron-right"></span></a></button>
            </div>
          </div>
          <div id="events_feed" class="col-sm-5 ">
            ...
            <div class=" event_item">
              <button class="btn btn-block btn-sm"><a href="<?php echo home_url('/events/'); ?>" alt="Go to the Events Calendar">Go to the Events Calendar <span class="glyphicon glyphicon-chevron-right"></span></a></button>
            </div>
          </div>
        </div>
      </div>
