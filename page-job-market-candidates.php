...
<?php $person_type="Job Market Candidates"; ?>
  ...
  <div class="row">
    ...
    <div class="col-md-10 content">
      <div class="row">
        ...
        ?>
        <?php
          $query = new WP_Query( array( 'post_type' => 'people', 'position'=>'job-market-candidates', 'posts_per_page' => '-1', 'offset' => '0', 'order' => 'ASC', 'orderby' => 'title' ));
          if ( $query->have_posts() ) {
            ...
            echo '<div class="row even_height_container">'; // wraps the whole people grid
          	...
          	<p>We do not currently have any job candidates. Please check back soon.</p>
          <?php }
          wp_reset_postdata();
        ?>
      </div>
